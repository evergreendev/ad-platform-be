...
namespace API.Data.Migrations
{
    ...
    [Migration("20260515175744_add_email_scheduling")]
    partial class add_email_scheduling
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Models.EmailMessage", b =>
                {
                    ...
                    b.Property<string>("SchedulerJobId")
                        .HasColumnType("text")
                        .HasColumnName("scheduler_job_id");
                    ...
                    b.HasIndex("ScheduledFor")
                        .HasDatabaseName("ix_email_message_scheduled_for");

                    b.HasIndex("SchedulerJobId")
                        .HasDatabaseName("ix_email_message_scheduler_job_id");
